...
var Page = {
    ...
    // ============= VARS ==============
    url : "http://hathanhtam.chinhlatoi.top/", //-- co slash cuoi /
    mainkeyWord : "ha thanh tam",
    longkeyWords : ["Email Marketing", "Landing Page", "IT services"],
...
var Social = {
    //-- de trong "" de giu nguyen default text
    email: "maito:tamht@onlikeservices.com",
    facebook: "https://www.facebook.com/tam.ha.33234571",
    twitter: "twitter.com",
    google: "google.com",
...
var Person = {
    //-- de trong "" de giu nguyen default text
    logoText: "Hà Thanh Tâm",
    fullname: "<strong>Hà Thanh Tâm</strong>.",
    slogan: "Dịch vụ IT tại nhà",
    sex: '<i class="fa male"></i>', //-- male, female
    phone: 'tel:0907401030',
    // message: "Tôi đã sẵn sàng, còn bạn thì sao?", //-- thong diep chinh hien nay!
    message: "Luôn sẵn sàng làm hài lòng các khách hàng",
    
    email: "mailto:tamht@onlikeservices.com",
    facebook: 'https://www.facebook.com/tam.ha.33234571',
    facebook: "https://www.facebook.com/tam.ha.33234571",
    twitter: "twitter.com",
    google: "google.com",
